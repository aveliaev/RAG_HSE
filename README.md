...
![Live Dashboard — метрики и графики](docs/photo/main.png)
...
![Live Dashboard — метрики и графики](docs/photo/online_metrics.png)
...
![Live Dashboard — ответ пользователя](docs/photo/online_answer.png)
...
![RAG Evaluation Dashboard](docs/photo/offline_metrics.png)
...
![RAG Latency](docs/photo/offline_time.png)
![RAG ansewr](docs/photo/offline_answer.png)
...
# Опционально — YandexGPT вместо Groq
