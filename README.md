...
![Live Dashboard — метрики и графики](photo/main.png)
...
![Live Dashboard — метрики и графики](photo/online_metrics.png)
...
![Live Dashboard — ответ пользователя](photo/online_answer.png)
...
![RAG Evaluation Dashboard](photo/offline_metrics.png)
...
![RAG Latency](photo/offline_time.png)
![RAG ansewr](photo/offline_answer.png)
