...
<p align="center">
  <img src="photo/example_of_work.jpg" width="450" title="Пример работы бота">
</p>
...
- Дизлайк на кешированный ответ => убирается из кеша, отправляется на проверку
- 📊 Два дашборда для мониторинга (подробнее ниже)
- Можно спросить робота не в любом чате, где он есть, с помощью команды  `@бот вопрос`
- Калькулятор баллов ЕГЭ и ИД
...
| LLM | Groq `llama-3.3-70b-versatile` / YandexGPT |
